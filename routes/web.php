...
// Pintu Masuk Utama (Traffic Controller)
...
Route::middleware(['auth', 'role:petugas'])->prefix('petugas')->name('petugas.')->group(function () {
    ...
    // TAMBAHKAN BARIS INI:
    Route::post('kendaraan/store', [TransaksiController::class, 'storeKendaraan'])->name('kendaraan.store');
});

// GRUP OWNER
Route::middleware(['auth', 'role:owner'])->prefix('owner')->name('owner.')->group(function () {
    Route::get('dashboard', [DashboardController::class, 'ownerDashboard'])->name('dashboard');
    Route::get('cetak-rekap', [DashboardController::class, 'cetakRekapTransaksi'])->name('cetak-rekap-transaksi');
});
